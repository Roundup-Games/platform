...
',
  ...
  1 => 
  array (
    'slug' => 'dice-pool-system',
    'name' => 'Dice Pool System',
    'description' => 'A dice pool system does not refer to any specific tabletop roleplaying game system, but rather a common mechanic used in many different games. In RPGs that use a dice pool as their core mechanic, players roll a number of dice simultaneously to resolve actions and challenges, rather than a single die.

The number of dice and which dice might be the same every time, or it might depend on the character\'s skill level or ability in the particular action they\'re rolling for. Different RPGs make different choices about what the dice pool looks like; in some games, all the dice might be the same size, most commonly d6s, but d10s, d12s, d20s and d4s also appear, and doubtless there are games using every conceivable die size! In some games, a single dice pool might even contain different sizes of die, perhaps bigger dice for greater skill, or otherwise modified by circumstances around the roll.

Dice pool games also vary on how players interpret results. In many games, certain faces of each die represent "hits" or "successes," like 6 or greater, or maybe only 6s. Sometimes, the pool must be summed and compared to a target number. Some games seek to create sets that add up 10 or some other number, and still others use dice with symbols that compound and/or cancel each other out. Still other games might only keep the one or two highest (or lowest) results!

Dice pool systems frequently exist in concert with other mechanics, like exploding dice, where some results add additional dice to the pool, re-rolls, "botches" or critical failures attached to a specific result, or special additional dice that add complexity, benefits, or complications to the final result.

Dice pools are among the most popular resolution mechanics in RPGs, as seen in Vampire: The Masquerade and other World of Darkness games, Fabula Ultima, Fate, Blades in the Dark, the many Year Zero Engine games, Fantasy Flight Games\' Star Wars RPGs, Shadowrun, and many more.',
    'popular_rpgs' => 
    array (
      0 => 
      array (
...
In Werewolf: The Apocalypse, you play as the Garou, a creature of flesh and spirit, blessed and cursed with primal rage. Born to fight and die in a desperate war to protect Gaia — the very living earth — you engage in an unequal battle against the greed and power-hunger of human civilization that has trapped the world in a choking web of technology and corruption.',
    ...
    'similar_mechanics' => 
    array (
      0 => 'storyteller-system',
      1 => 'fudge-system',
      2 => 'd616-role-playing-system',
      3 => 'exploding-dice',
      4 => 'illuminated-worlds-system',
...
In Delta Green: The Role-Playing Game, the players are those agents. They fight to keep terrors from beyond space and time from infecting the world and claiming human lives and sanity. The Handler is the game moderator who creates and interprets their world, presents the unnatural horror that they investigate, and describes the awful aftermath of their sacrifices.',
  ...
  array (
    ...
    'description' => 'Powered by the Apocalypse, or PbtA, is perhaps one of the most prolific game engines ever, with thousands of games spanning every genre, theme, and tone you can imagine. This style of game gets its name from Apocalypse World, a groundbreaking game originally published in 2010 by Vincent and Meguey Baker about people surviving in a post-apocalyptic wasteland. The designers allowed anyone who wished to adapt and use the game\'s mechanics, and the Powered by the Apocalypse movement was born.

PbtA\'s design philosophy focuses on "the fiction," the shared collaborative narrative that roleplaying games generate as they\'re played, and "the conversation," the negotiation, worldbuilding, character interaction, player action and GM reaction that keeps games alive at the table. Beyond this, due to the highly democratized nature of the movement and the diversity of its designers, PbtA games can look extremely different from one another, and no single element is common to all of them. However, a number of conventions have emerged.

Most common are "moves," which are mechanical triggers available to players and game masters alike. Player moves trigger when they take specific actions in the fiction, like "act under fire," "seduce or manipulate someone," or "seize by force" in Apocalypse World. A move usually tells players what to roll, and what outcomes they can potentially expect. GM moves are typically reactions the game master can make when players roll poorly, invite a consequence or complication, or look to the GM to see what happens next. They can also use GM moves to foreshadow trouble and introduce threats into the fiction.

Players usually roll two six-sided dice and add a relevant stat to resolve their moves, and in many PbtA games, a total of 6 or less is a miss, or bad outcome, a 7-9 is a partial success, where they get most or all of what they wanted, but at a cost, and a 10 or higher is a complete success, with no complications. Because of this, the GM typically doesn\'t roll at all, as the player\'s roll covers both their own action and the opposition\'s response. Many PbtA games also have classes, sometimes called "playbooks," which have special moves, equipment, and narrative roles.

Players in PbtA games tend to have more narrative control than in many other game styles, as collaboration on worldbuilding, character relationships, and the shared fiction is strongly encouraged. PbtA RPGs also maintain a tight focus on a specific genre or theme, and tailor their mechanics to delivering on it. For example, Avatar Legends (fantasy adventure a la Avatar: The Last Airbender), Apocalypse World (Mad Max-style post-apocalyptic survival), Monster of the Week (supernatural monster-hunting mystery), Masks (teen superhero drama), Urban Shadows (urban fantasy), Brindlewood Bay (murder mystery eldritch horror), Monsterhearts (paranormal teen drama), Thirsty Sword Lesbians (thirsty sword lesbians), and thousands more. If you\'re looking for a game with a laser focus on collaborative storytelling in your favorite genre, it\'s practically guaranteed that there\'s a PbtA game out there for you.',
    'popular_rpgs' => 
    array (
      0 => 
      array (
...
Masks: A New Generation is a superhero roleplaying game in which a team of young heroes fights villains, saves lives, and tries to figure out who they are—noble paragons? Dark avengers? Or regular kids? All against the backdrop of Halcyon City, the greatest city in the world.',
  ...
  array (
    'slug' => 'osr',
    'name' => 'OSR',
    'description' => 'The Old School Renaissance (also known as Old School Revival), or OSR, is a movement in tabletop roleplaying games dedicated to a playstyle derived from the rulebooks of classic RPGs, like the early editions of Dungeons & Dragons. The OSR is a decentralized, democratic game design philosophy, so there is no singular definition or authority on the movement, but there are some broad commonalities to OSR games at large. 

The mechanics of OSR games tend to originate from Basic/Expert D&D, as revised in 1981 by Tom Moldvay and Dave Cook. Hallmarks of these games include random character generation, perhaps rolling 3d6 for their stats to determine their capabilities; rolling a d20 and adding bonuses to beat target numbers or opponent\'s armor or defense scores; random tables for dungeon generation, NPC attitudes, and encounters; limited inventory and character abilities; and hit points that determine how many hits your character can take before they\'re defeated. None of these are ubiquitous; any given OSR game might or might not use these mechanical touchstones. Many streamline, update, or remix these rules as well.

One thing that does tend to unite OSR games is the "old-school" gaming philosophy. This emphasizes "rulings over rules," meaning the game master\'s adjudication is more important than exhaustive rules for every situation in the book. OSR games tend to be very light on rules for this reason. Characters also have generally lower power levels than heroic fantasy games, as the OSR is more concerned with creative problem solving and player skill than character powers. These games eschew "game balance" and prewritten plots in favor of clearly established scenarios that players must decide how to navigate for themselves. If their characters can\'t win a head-to-head fight against a dragon, they must come up with a clever plan or run away!

The OSR movement began in the mid-2000s, and has exploded in popularity over the last two decades. OSR games exist in all genres, from fantasy to science fiction, cyberpunk to western, lighthearted to deadly serious. Some of the most popular entries include Shadowdark, Mothership, Mörk Borg, Into the Odd, Dungeon Crawl Classics, Old School Essentials, Cairn, and "retro-clones" like Basic Fantasy, which aim to faithfully reproduce classic editions of D&D. There are even some games which embrace the "NSR," or "New School Renaissance," as designers produce second- and third-generation iterations of OSR games.

What makes an OSR game? If a game associates itself with the Old School Renaissance, you can generally expect light, modular rules you and your table can make your own, an emphasis on player skill in the face of serious danger, the real possibility of defeat, open-ended challenges, and unscripted play. ',
    'popular_rpgs' => 
    array (
      0 => 
      array (
...
In Werewolf: The Apocalypse, you play as the Garou, a creature of flesh and spirit, blessed and cursed with primal rage. Born to fight and die in a desperate war to protect Gaia — the very living earth — you engage in an unequal battle against the greed and power-hunger of human civilization that has trapped the world in a choking web of technology and corruption.',
  ...
  array (
    'slug' => 'exploding-dice',
    'name' => 'Exploding Dice',
    'description' => 'Exploding dice refers to a tabletop roleplaying game mechanic where dice that roll a certain value, usually their highest, add an additional die of that type to the roll. It\'s an exciting occurrence with an exciting name that adds an element of unpredictability and possibility to every roll. Even a desperate situation unlikely to succeed can explode into an extraordinary success with a little bit of luck.

Typically, dice can explode indefinitely, meaning dice added to the roll by explosion can also themselves explode, creating the possibility (however remote) of infinite dice! At some point, however, you\'ll certainly roll enough successes or a high enough total to completely succeed at the action being rolled for. Depending on the game, dice might be summed together or rolled to achieve "hits" or "successes" of some number or higher. In either case, an explosion represents an additional chance to succeed. Sometimes, dice added by explosion cannot explode themselves.

Exploding dice usually, though not always, exist in a dice pool system, where explosions add to the pool. In some cases, though, exploding dice systems only typically roll one or two dice, allowing explosions to produce otherwise impossible levels of success, much like critical hits in other games. In any case, exploding dice are a great way to add some extra excitement to the already fun process of rolling dice!

Popular systems with exploding dice include Savage Worlds, Deadlands, and the Kids on... series, including Kids on Bikes and Kids on Brooms. Games like Legend of the Five Rings, Rolemaster, Star Wars d6, the Cyberpunk series, older editions of World of Darkness games and Shadowrun, and many more also use exploding dice.',
    'popular_rpgs' => 
    array (
      0 => 
      array (
  ...
  array (
    ...
    'description' => 'The Year Zero Engine is a mechanical system for tabletop roleplaying games. Originally introduced in post-apocalyptic survival game Mutant: Year Zero, it has gone on to become the flagship in-house game system for prolific Scandinavian TTRPG publisher Free League. It uses a dice pool system, primarily with d6s, but occasionally with d8s, d10s, and d12s. Characters typically have four attributes, each of which is associated with four skills, depending on the game and setting. They often have a class, job, or role that gives them a few benefits, as well as a selection of talents that offer special skills.

The core mechanic of the Year Zero Engine, or YZE is rolling a pool of dice assembled from a player character\'s rating in the relevant attribute and skill, any gear helping them, and any bonuses or penalties from help or circumstances. Any die that rolls six (or higher) counts as a success. Usually, one success is enough to succeed on a given roll, though opposed rolls might cancel out successes, and some rolls may care about how many total successes are achieved. If a player is unhappy with their result, they can "push" the roll, re-rolling any dice that don\'t show 6 or 1. If they do, there is typically a cost for every die showing 1 in the final result, usually damage to the relevant attribute and/or stress. If the 1 came from a gear die, the gear might be damaged.

Games using the Year Zero Engine often emphasize survival, resource management, and overland travel, tracking necessities like food and water. Each resource has a die assigned to it, from a d12 for an abundance, down to a d6 for a dwindling amount. Whenever the resource is used or spend, the player rolls the associated die. The resource reduces in size if a 1 or 2 is rolled, and it\'s completely depleted if it\'s a d6 and would reduce. 

Combat in YZE is fast and dangerous, taking place in zones rather than exact distances. Initiative is decided by drawing cards rather than rolling dice, and in some games initiative is redrawn each round. Characters can move and take one action on each turn. If a character takes enough damage in combat, they are "broken," and roll on a random table of injuries based on the type of damage sustained. These injuries range from inconveniences to dismemberment to, in rare cases, the instantly lethal.

The Year Zero Engine is the game system powering many of Free League Publishing\'s most popular games, including ALIEN, Blade Runner, Forbidden Lands, Vaesen, The Walking Dead, Tales from the Loop, and more! It\'s a dynamic, versatile, adventure-focused system easily adaptable to many settings and genres. ',
    'popular_rpgs' => 
    array (
      0 => 
      array (
...
They know to fear it.',
  ...
  8 => 
  array (
    'slug' => 'interlock-system',
    'name' => 'Interlock System',
    'description' => 'The Interlock System is R. Talsorian Games\' proprietary roleplaying game system, originally created for its Mekton and Cyberpunk series games. The system uses ten-sided dice, nine attributes, and is skill-based, rather than class-based. Character creation also uses a unique Lifepath system for semi-randomly generating a character\'s background.

The core mechanic of the Interlock system is rolling a d10 and adding the relevant stat and skill bonus, both rated on a scale from 0-10. The final result is compared to a target number set by the game master based on the difficulty of the task at hand, usually ranging from 12-20. Meeting or exceeding this difficulty means the action is a success. There is also the potential for critical success and critical failure depending on the d10 roll.

Characters in the Interlock system are the sum of their attributes and skills. Attributes have a minimum value of 2 and go up to 10, and skills start at 0 but can also raise to 10, representing the maximum possible skill level. There are no character classes in Interlock, with players defined by the skills they specialize in, though some games include "profession packages" of suggested skills for particular jobs in the world.

Interlock also includes a character background generation system called Lifepaths. Through a unique combination of random rolls, you can produce a unique character with an eclectic blend of life experiences. These create narrative hooks for the character, like personal connections, style, family, life events, and employment history.

The Interlock System is probably best known for its use in the Cyberpunk RPG series, including Cyberpunk 2013, Cyberpunk 2020, and Cyberpunk RED.',
    'popular_rpgs' => 
    array (
      0 => 
      array (
  ...
  9 => 
  array (
    'slug' => 'forged-in-the-dark',
    'name' => 'Forged in the Dark',
    'description' => 'Forged in the Dark is a system of game mechanics for tabletop roleplaying games. Inspired by Powered by the Apocalypse games and first appearing in Blades in the Dark, Forged in the Dark (or FitD) is a d6 dice pool system that emphasizes risk-taking, competent player characters, low-prep collaborative storytelling, and consequential dice rolls.

The core mechanic of Forged in the Dark games is rolling a pool of six-sided dice, the size of which is determined by a character\'s base rating in the action they\'re taking, and might be increased by spending resources or receiving help. Only the highest result counts; a 1, 2, or 3 on the highest die is a bad outcome, and the rolling player character faces the consequences without getting what they want. A 4 or 5 is a mixed success; the character gets what they want, but the consequences still manifest. A 6 is a complete success; the character gets what they want and avoids consequences. If the roll includes two 6s, it\'s a critical success, and the character gains an additional bonus or edge.

Depending on the game, characters might have a resource, often called stress, which they can spend to boost their die rolls, resist consequences they don\'t want, and even flash back to reveal how they prepared for a challenge retroactively. Another common element of FitD games is clocks, circular tracks with 4-12 segments that indicate progress, mounting threats, or countdowns. Players might need to roll to fill the six segments of a high-security vault\'s door to bypass it. The GM might start and tick a four segment clock for the cops to show up as a consequence on an attempt to sneak into a government building. The ticking of a twelve segment clock might indicate the imminent countdown to the completion of a ritual or charging of a superweapon! Clocks are an easy visual way for players and game masters to show time pressure and give anything "hit points," even intangible things like stealth or willpower.

FitD games also often center a "crew," the party itself, as the focus of the game. The crew typically has its own character sheet, special abilities and resources it confers upon anyone in the party, and ways to advance just like characters do. Depending on the game, a crew might represent a criminal enterprise, a noble house, an army, a spaceship, or a friend group! As the crew advances, the characters in it grow more notable and can take on greater challenges. Players can even play multiple characters, switching between them as they like, but everyone is part of the crew.

Blades in the Dark was the first to pioneer this system, but many others have followed, producing games in several genres. Scum & Villainy for sci-fi and space opera, Girl by Moonlight for magical girl, anime, and superheroes, Band of Blades for gritty military fantasy, Bump in the Dark for monster-hunting mystery, Court of Blades for Renaissance political intrigue, Slugblaster for wacky teenage hijinks, and many, many more! Several games also list inspiration or share features from Blades in the Dark, but don\'t consider themselves FitD, such as Trophy, Candela Obscura, Grimwild, and Wildsea.',
    'popular_rpgs' => 
    array (
      0 => 
      array (
...
Work with the members of your crew to thrive despite powerful criminal syndicates, warring noble families, dangerous aliens, and strange mystics. Explore the ruins of lost civilizations for fun and profit. Can your motley crew hold it together long enough to strike it big and insure your fame across the sector?',
  ...
  array (
    'slug' => '2d20-system',
    'name' => '2d20 System',
    'description' => 'The 2d20 system was developed as a cinematic tabletop roleplaying game rule set by the publisher Modiphius for games based on intellectual properties like the Dune RPG, the Fallout RPG, and the Star Trek RPG. They also use it for a few of their original games, like Achtung! Cthulhu and Dreams and Machines.

As you might guess, the core mechanic in the 2d20 system has players roll two twenty-sided dice. You compare these rolls to a target number, counting rolls that come up that number or lower as a success. Lower rolls are generally better in 2d20 systems! Your target number depends on the specific game, but is often based on your character\'s attributes, which will be higher if your character is more skilled, making it more likely to score a success. You might also have a more specific skill as a supplementary target number, and rolling under that might count as two successes!

After the roll, you count your total successes and compare it to a difficulty set by the game master, usually 1 or 2, but this can go even higher for more difficult and dangerous tasks. If you have successes equal to the difficulty, you succeed! If you have fewer than you need, you fall short in some way. If you have more successes than you needed, they get converted into a currency, which differs depending on the game. In most games, you can spend this currency to activate special abilities, push your luck by rolling extra dice, and take extra actions. This currency is often called "momentum" or something similar, representing how characters can press their success!

The GM also has a currency, which accumulates when players push their luck, often called "doom" or "threat," which they can spend to complicate the players\' lives, introduce new problems, and generally make their lives interesting. ',
    'popular_rpgs' => 
    array (
      0 => 
      array (
...
A new threat looms from across the Gamma Quadrant, as it is confirmed by Commander Sisko and his crew that the Dominion, led by the Founders, represent a significant threat to the Alpha Quadrant. Tension is already high in the region of Bajor and Deep Space 9, as the Maquis continue to act against the Cardassian-Federation peace treaty, with Captain Janeway and the crew of the U.S.S. Voyager preparing for their mission in the Badlands. It is a volatile time for the Federation and new crews have never been in higher demand.',
  ...
  11 => 
  array (
    'slug' => 'narrative-dice-system',
    'name' => 'Narrative Dice System',
    'description' => 'The Narrative Dice System is a unique tabletop roleplaying game mechanic using custom dice. Originally created by Fantasy Flight Games for the third edition of Warhammer Fantasy Roleplay, and later used for their Star Wars RPG series as well as their generic system Genesys, its bespoke narrative dice give make sure every roll impacts the story.
...
Player characters get to choose their abilities and areas of expertise to influence how many positive dice they\'ll get to roll in relevant situations, and hopefully mitigate the Setbacks, Difficulties, and Challenges.

The combinations of all these symbols mean every die roll in the Narrative Dice System has a vast array of possible outcomes, not just pass or fail. Every roll becomes meaningful and can change the course of the story, introducing new boons and bonuses, exciting threats and complications, and twists that surprise everyone at the table, even the game master! The dice become contributors to your table\'s shared collaborative storytelling.',
    'popular_rpgs' => 
    array (
      0 => 
      array (
...
',
  ...
  12 => 
  array (
    'slug' => 'd616-role-playing-system',
    'name' => 'd616 Role-Playing System',
    'description' => 'The d616 Role-Playing System is a set of rules and game mechanics originally designed for the Marvel Multiverse RPG. The system uses three six-sided dice, one of which is designated the "Marvel die," and has a Marvel logo in place of the 1. The core mechanic is the Action Check, when a hero attempts something dangerous, like fighting a supervillain. So how does it work?

To make an Action Check, a player rolls two normal six-sided dice and the Marvel die, then sums the total of the roll. Whatever the result, players also get to add one of their six ability scores, whichever is most relevant to their action, and compare the total roll to a target number set by the game master. This target number is based on the difficulty of the action and strength of the opposition. If the final result is equal to or greater than the target number, the action succeeds!

The Marvel die is special, and if it rolls the Marvel logo, it counts as a 6 and the action becomes Fantastic, granting an additional edge to the character whether they succeed or fail. If they roll two 6s on the other two dice as well, it\'s an Ultimate Fantastic Success, and automatically succeeds with bonus benefits.

Characters might also have edges or trouble, which can modify their rolls. Edges represent circumstantial advantages or momentum from previous Fantastic Successes, and allow players to re-roll any die they choose. Trouble comes from unfavorable circumstances or lack of expertise, and forces players to re-roll their highest die.

As characters grow more powerful and increase in rank, their challenges often increase in difficulty, as do their powers and abilities. This way, you can start as street-level heroes who grow over time into near-cosmic forces to be reckoned with!',
    'popular_rpgs' => 
    array (
      0 => 
      array (
  ...
  13 => 
  array (
    'slug' => 'powered-by-mörk-borg',
    'name' => 'Powered by Mörk Borg',
    'description' => 'Mörk Borg, a hyper-stylish, rules-light, old-school, Swedish death metal tabletop roleplaying game, released in 2020 to instant success. Its minimalist rules and maximalist aesthetic design captured the hearts and imaginations of thousands of RPG fans eager to jump into its apocalyptic pages, roll up a graverobbing scumbag of a player character, die in the muck of a pitch-black dungeon, and do it all over again. In no time at all, Mörk Borg inspired adaptations porting its ultralight rules system to other genres and settings, including cyberpunk, pirate, science fiction, science fantasy, orcs, and... ducks?

The core of the system itself is quite simple: randomly roll your character\'s hit points, equipment, and abilities (and optionally, a class and a few other odds and ends, depending on the game) and send them forth into the world to prosper or die. Characters are quite fragile, so character creation is mercifully quick. Death won\'t keep you out of the game for long! When confronted with a challenge, characters can test their abilities by rolling a d20, adding or subtracting a modifier from their abilities or circumstances, and trying to roll equal to or greater than the Difficulty Rating, or DR.

In combat, rather than having enemies roll to hit, player characters roll to dodge or defend themselves. Armor reduces incoming damage, and hit points determine how much damage a character can take before they die. Due to the dark tone of most games powered by Mörk Borg, magic, technology, and monsters are usually terribly dangerous and cursed, and there is usually a creeping apocalyptic threat looming, waiting to end this horrible world once and for all. 

Other than Mörk Borg itself, several games use the system it pioneered, including Death in Space, Vast Grimm, CY_BORG, Orc Borg, Pirate Borg, and Dukk Borg, among several others!',
    'popular_rpgs' => 
    array (
      0 => 
      array (
...
',
  ...
  14 => 
  array (
    'slug' => 'illuminated-worlds-system',
    'name' => 'Illuminated Worlds System',
    'description' => 'Illuminated Worlds is a game system originally created for Darrington Press\'s supernatural investigation game Candela Obscura. It was based on the Forged in the Dark system of Blades in the Dark and the Year Zero Engine of Vaesen. The system uses pools of six-sided dice and focuses on teams of investigators delving into fantastical mysteries. 

The core mechanic involves rolling a number of d6s based on your character\'s rating in the relevant Action and reading the highest result. If the best die is a 3 or less, the action fails and consequences ensue. If it\'s a 4 or 5, the roll is a mixed success; you accomplish what you wanted, but there\'s a cost or complication. On a 6, the roll completely succeeds with no consequences, and if multiple 6s appear in the result, it\'s a critical success and you gain an additional bonus.

Illuminated Worlds gives players a few tools to tip the scales in their favor: Drives represent characters\' ability to push themselves, and they can spend points of their Drives to add bonus dice to an important roll or help an ally. Drives also have some number of Resistances that allow players to re-roll dice when they don\'t like the result. Each character will also have Gilded Actions, which replace one die rolled for that action with a special d6 called a gilded die, which replenishes one point of a drive whenever you choose to use its result (even if it\'s not the highest one).

In addition to creating characters with unique abilities, Illuminated Worlds also has a system for creating a Circle, or the group to which your characters belong. The Circle has abilities and resources that everyone in the group has access to, and represents the strength of their organization. The Circle can grow, change, and advance just like player characters can.',
    'popular_rpgs' => 
    array (
      0 => 
      array (
  ...
  array (
    'slug' => 'fudge-system',
    'name' => 'Fudge System',
    'description' => 'The Fudge System is a generic tabletop roleplaying game system that uses "fudge dice", six-sided dice marked with two plus signs, two minus signs, and two blank sides. Originally an acronym for the Freeform Universal Donated Game Engine, Fudge was designed as a basic mechanical system on which other designers could build their game.

The core mechanic is rolling the four fudge dice and counting the total value of all the plus and minus signs. The two signs cancel each other out, giving a potential range of -4 to +4 and an average roll of 0 on a very evenly distributed bell curve. This die result may then be modified by a character\'s skill level and then compared to a difficulty set by the game master, ranked using an ascending system of descriptive adjectives. A more difficult challenge will have a higher difficulty. A total that meets or exceeds the difficulty succeeds. 

The best-known implementation of the Fudge system is the Fate RPG and its derivatives, like the Dresden Files RPG, Fate Accelerated, Atomic Robo, Spirit of the Century, and more. Fate adds Fate points, a metacurrency players can spend for bonuses and special permissions, as well as levels of success like succeeding at a cost. The Fudge system, and Fate by extension, are designed to be setting-agnostic, allowing game designers and game masters to customize the game.

Fudge remains one of the simplest roleplaying game systems ever designed, and represents a paradigm shift in TTRPG design that still resonates today.',
    'popular_rpgs' => 
    array (
      0 => 
      array (
  ...
  16 => 
  array (
    'slug' => 'essence-20-system',
    'name' => 'Essence20 System',
    'description' => 'Essence20 is a mechanical system for tabletop roleplaying games designed as a flexible system for a series of games based on popular franchises like Power Rangers, Transformers, GI Joe, and My Little Pony. 

The core mechanic of Essence20 involves rolling a twenty-sided die and one additional die and comparing the sum to a target number set by the game master.  Exceeding this target number is a success. The additional die used in the roll depends on the rolling character\'s skill at the task at hand, and ranges from a d2 to a d20!

Character abilities come from their Strength, Speed, Smarts, and Social stats, determined at character creation alongside their Origin, or background, Role, or purpose within their team, and Influence, or what caused them to become who they are.

Specialties allow characters to access the full "ladder" of dice when applicable, rolling not just their additional skill die but every die smaller than it, and choosing the highest result. Critical successes also occur when any die shows its maximum value, not just the d20.

These mechanics form the basic foundation for each Essence20 system game, which adds flavorful options, additional mechanics, and appropriate challenges and NPCs drawn from the worlds and properties of each game\'s setting.',
    'popular_rpgs' => 
    array (
      0 => 
      array (
