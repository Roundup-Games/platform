...
describe('English locale page rendering', function () {
...
describe('German locale page rendering', function () {
...
describe('Flash message German translations', function () {
...
describe('Authenticated page German rendering', function () {
...
describe('Domain-specific flash/validation German translations', function () {
