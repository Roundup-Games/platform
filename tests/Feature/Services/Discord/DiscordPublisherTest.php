...
class DiscordPublisherTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // publishing_enabled defaults OFF (MEM918); these tests exercise the
        // publisher directly, so enable it by default. Individual tests that
        // assert the master-switch gate flips it back off explicitly.
