...
function benchCreateFullCampaignSession(User $owner, GameSystem $system, Campaign $campaign, int $maxPlayers = 3): Game
{
    $game = Game::create([
        ...
        'campaign_id' => $campaign->id,
        'game_system_id' => $system->id,
        'name' => ['en' => 'Test Session'],
        'date_time' => now()->addDays(10),
        'description' => ['en' => 'A test session'],
        'expected_duration' => 3,
        'visibility' => 'public',
        'status' => 'scheduled',
        'language' => 'en',
...
test('add to bench throws for standalone game', function () {
    $game = Game::create([
        ...
        'name' => ['en' => 'Standalone'],
        'date_time' => now()->addDays(10),
        'description' => ['en' => 'Standalone game'],
        'expected_duration' => 3,
        'visibility' => 'public',
        'status' => 'scheduled',
        'language' => 'en',
...
// ── isBenchMode ──────────────────────────────────────────
// Covered by tests/Feature/Waitlist/BenchModeToggleTest.php (4 parameterized tests)
