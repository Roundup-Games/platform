...
class ProcessDiscordRsvpTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // publishing_enabled defaults OFF (MEM918); card-refresh coverage needs
        // it ON so the publisher's defense-in-depth gate actually proceeds —
        // mirrors RefreshDiscordCardTest / PublishDiscordDigestTest.
        config([
