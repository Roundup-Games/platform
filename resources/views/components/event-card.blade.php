    ...
    <a href="{{ route('events.detail', $event->slug) }}" wire:navigate class="block">
        ...
        <div class="relative bg-gradient-to-br from-primary to-primary-container px-4 py-3">
            <div class="flex items-center justify-between">
                ...
                @if($event->status === 'registration_open')
                    <span class="text-xs font-medium text-on-primary/80 bg-on-primary/20 backdrop-blur-sm px-2 py-0.5 rounded-full">Registration Open</span>
                @endif
            </div>
        </div>
        ...
        <div class="p-4">
            ...
            <div class="mt-4 pt-3 bg-surface-container-low bg-clip-padding flex items-center justify-between">
                ...
                <span class="text-xs text-primary font-medium hover:underline">View Details →</span>
            </div>
        </div>
    </a>
</div>
