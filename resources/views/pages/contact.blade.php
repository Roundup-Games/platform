                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 bg-[#C12E26]/10 dark:bg-[#C12E26]/20 rounded-lg flex items-center justify-center shrink-0">
                                <svg class="w-5 h-5 text-[#C12E26]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                            </div>
                            <div>
                        ...
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 bg-[#C12E26]/10 dark:bg-[#C12E26]/20 rounded-lg flex items-center justify-center shrink-0">
                                <svg class="w-5 h-5 text-[#C12E26]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            </div>
                            <div>
