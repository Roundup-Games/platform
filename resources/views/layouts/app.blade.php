...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-on-surface antialiased bg-surface dark:bg-[#1b1c17]">
        ...
        <div class="min-h-screen flex flex-col bg-surface dark:bg-[#1b1c17]">
            ...
            {{-- ============================================================ --}}
            <div class="lg:hidden bg-surface dark:bg-[#2a2b24] border-b border-outline-variant/15" x-data="{ open: false }">
                <div class="flex items-center justify-between px-4 py-3">
                    <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center gap-2">
                        <span class="text-xl font-heading font-bold text-primary tracking-tight">Roundup<span class="text-on-surface dark:text-[#eae8e0]">Games</span></span>
                    </a>
                ...
                <div x-show="open"
                     ...
                     class="bg-surface/95 dark:bg-[#2a2b24]/95 backdrop-blur-md border-b border-outline-variant/15">
            ...
            <div class="flex flex-1">
                ...
                {{-- ======================================================== --}}
                <aside class="hidden lg:flex lg:flex-col lg:w-64 bg-surface-container-low dark:bg-[#1b1c17] border-r border-outline-variant/15 min-h-screen sticky top-0 h-screen overflow-y-auto">
                    ...
                    <div class="border-t border-outline-variant/15 p-4">
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 rounded-full bg-primary/10 dark:bg-primary/20 flex items-center justify-center">
                                <span class="text-primary font-heading font-bold text-sm">{{ strtoupper(Auth::user()->name[0] ?? 'U') }}</span>
                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-medium text-on-surface dark:text-[#eae8e0] truncate">{{ Auth::user()->name }}</p>
                ...
                <div class="flex-1 flex flex-col min-w-0">
                    ...
                    {{-- Top Bar (Desktop) — cream bg, sticky --}}
                    <header class="hidden lg:flex h-16 bg-surface dark:bg-[#2a2b24] border-b border-outline-variant/15 items-center justify-between px-6 sticky top-0 z-40">
                        <div class="flex items-center">
                            @hasSection('title')
                                <h1 class="font-heading text-lg font-semibold text-on-surface dark:text-[#eae8e0] tracking-tight">
                                    @yield('title')
                                </h1>
                            @elseif(isset($header))
                                <h2 class="font-heading text-lg font-semibold text-on-surface dark:text-[#eae8e0] tracking-tight">
                                    {{ $header }}
                                </h2>
                            @else
