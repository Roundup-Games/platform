<div class="py-8">
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-heading font-bold tracking-tight text-on-surface">Browse Teams</h1>
                <p class="text-sm text-on-surface-variant mt-1">Discover and join teams in your area.</p>
            </div>
            @auth
                    ...
                    <a href="{{ route('teams.detail', $team->slug) }}" wire:navigate class="block bg-surface-container-lowest rounded-xl shadow-ambient hover:shadow-elevated transition-shadow overflow-hidden group">
                        ...
                        <div class="p-5">
                            ...
                            @if($team->founded_year)
                                <p class="mt-2 text-xs text-on-surface-variant/70">Est. {{ $team->founded_year }}</p>
                            @endif
                        </div>
                    </a>
                @endforeach
        ...
        @else
            <div class="text-center py-16 bg-surface-container-lowest rounded-xl">
                ...
                <h3 class="mt-2 text-sm font-medium text-on-surface">No teams found</h3>
