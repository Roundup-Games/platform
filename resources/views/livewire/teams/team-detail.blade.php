<div class="py-8">
    <div class="max-w-4xl mx-auto space-y-6">
        {{-- Back --}}
        <a href="{{ route('teams.browse') }}" class="inline-flex items-center gap-1 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                <div class="flex items-start justify-between">
                    ...
                    @if($isCaptain)
                        <a href="{{ route('teams.manage', $team->slug) }}"
                           class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 text-sm font-medium transition-colors">
                            ⚙️ Manage
                        </a>
                    @endif
                </div>
                ...
                <div class="mt-4 flex flex-wrap gap-4 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    @if($team->website)
                        <a href="{{ $team->website }}" target="_blank" rel="noopener" class="text-[#C12E26] hover:underline">{{ $team->website }}</a>
                    @endif
                </div>
            </div>
        </div>
        ...
        <section class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <h2 class="text-xl font-['Oswald'] font-bold uppercase text-gray-900 dark:text-gray-100 tracking-wide mb-4">Roster</h2>
