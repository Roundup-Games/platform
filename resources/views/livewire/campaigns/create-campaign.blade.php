    ...
    <div class="max-w-2xl mx-auto space-y-8">
        ...
        <div>
            <div class="flex items-center gap-3 mb-1">
                ...
                <h1 class="text-2xl font-heading font-bold tracking-tight text-on-surface">Create Campaign</h1>
            </div>
            <p class="ml-8 text-sm text-on-surface-variant">Start a recurring campaign — sessions will be created from your schedule.</p>
        </div>

        {{-- Campaign Details --}}
        <section class="bg-surface-container-low rounded-xl shadow-ambient p-6">
            <h2 class="text-lg font-medium text-on-surface mb-4 font-heading">Campaign Details</h2>

            <div class="space-y-4">
                <div>
                    <label for="campaign-name" class="block text-sm font-medium text-on-surface mb-1">Campaign Name *</label>
                ...
                <div>
                    <label for="campaign-system" class="block text-sm font-medium text-on-surface mb-1">Game System</label>
                ...
                <div>
                    <label for="campaign-description" class="block text-sm font-medium text-on-surface mb-1">Description</label>
        ...
        {{-- Schedule --}}
        <section class="bg-surface-container-low rounded-xl shadow-ambient p-6">
            <h2 class="text-lg font-medium text-on-surface mb-4 font-heading">Schedule</h2>

            <div class="space-y-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label for="campaign-recurrence" class="block text-sm font-medium text-on-surface mb-1">Recurrence *</label>
                    ...
                    <div>
                        <label for="campaign-time" class="block text-sm font-medium text-on-surface mb-1">Time of Day *</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label for="campaign-duration" class="block text-sm font-medium text-on-surface mb-1">Session Duration (hours)</label>
                    ...
                    <div>
                        <label for="campaign-price" class="block text-sm font-medium text-on-surface mb-1">Price per Session ($)</label>
        ...
        {{-- Location & Visibility --}}
        <section class="bg-surface-container-low rounded-xl shadow-ambient p-6">
            <h2 class="text-lg font-medium text-on-surface mb-4 font-heading">Location & Visibility</h2>

            <div class="space-y-4">
                <div>
                    <label for="campaign-visibility" class="block text-sm font-medium text-on-surface mb-1">Visibility *</label>
                ...
                <div>
                    <label for="campaign-location-details" class="block text-sm font-medium text-on-surface mb-1">Location</label>
                ...
                <div>
                    <label for="campaign-language" class="block text-sm font-medium text-on-surface mb-1">Language</label>
