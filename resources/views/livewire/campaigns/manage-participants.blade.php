<div class="py-8">
    <div class="max-w-4xl mx-auto space-y-6">
        {{-- Back --}}
        <a href="{{ route('campaigns.detail', $campaign->id) }}" class="inline-flex items-center gap-1 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors">
        ...
        <section class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <h2 class="text-xl font-['Oswald'] font-bold uppercase text-gray-900 dark:text-gray-100 tracking-wide mb-4">Invite Player</h2>
                    ...
                    @foreach($pendingApplicants as $applicant)
                        <div class="flex items-center gap-4 py-3 first:pt-0 last:pb-0">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                @php
                                    $app = $campaign->applications->firstWhere('user_id', $applicant->user_id)
                                @endphp
                                @if($app?->message)
