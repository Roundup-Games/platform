...
<section class="bg-surface-container-lowest rounded-xl shadow-ambient p-6">
    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <div class="flex items-center rounded-lg bg-surface-container-highest/50 border border-transparent px-4 py-2.5 shadow-xs">
        ...
        <div>
            ...
            <input type="tel" id="profile-phone" wire:model="phone" placeholder="+49 151 1234567"
                   class="w-full rounded-lg bg-surface-container-high border border-transparent px-4 py-2.5 shadow-xs focus:border-secondary/20 focus:ring-1 focus:ring-secondary/20 text-on-surface placeholder:text-on-surface-variant/50" />
        ...
        <div>
            ...
            <textarea id="profile-bio" wire:model="bio" rows="3" maxlength="500"
                      ...
                      class="w-full rounded-lg bg-surface-container-high border border-transparent px-4 py-2.5 shadow-xs focus:border-secondary/20 focus:ring-1 focus:ring-secondary/20 text-on-surface placeholder:text-on-surface-variant/50 resize-y"></textarea>
