    ...
    <div class="max-w-2xl mx-auto space-y-8">
        ...
        <div>
            <div class="flex items-center gap-3 mb-1">
                ...
                <h1 class="text-2xl font-heading font-bold tracking-tight text-on-surface">Edit Profile</h1>
            </div>
            <p class="ml-8 text-sm text-on-surface-variant">Update your profile information and game preferences.</p>
        </div>
        ...
        <section class="bg-surface-container-lowest rounded-xl shadow-ambient p-6">
            <h2 class="text-lg font-heading font-semibold tracking-tight text-on-surface mb-4">Personal Information</h2>
        ...
        {{-- Game Preferences --}}
        <section class="bg-surface-container-lowest rounded-xl shadow-ambient p-6">
            <h2 class="text-lg font-heading font-semibold tracking-tight text-on-surface mb-1">Game Preferences</h2>
