        ...
        >
            @if($results->isEmpty())
                <div class="px-4 py-3 text-sm text-on-surface-variant text-center">
                    ...
                    @auth
                        <a href="{{ route('game-systems.request', ['locale' => app()->getLocale(), 'name' => $search, 'type' => 'boardgame']) }}" wire:navigate class="inline-flex items-center gap-1 mt-1 text-secondary hover:text-secondary/80 transition-colors">
