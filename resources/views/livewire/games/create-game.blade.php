        ...
        <section class="bg-surface-container-low rounded-xl shadow-ambient p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-on-surface-variant mb-3">{{ __('Describe the session vibe. Favorite what fits, avoid what doesn\'t.') }}</p>
                ...
                <div>
                    ...
                    <p class="text-xs text-on-surface-variant mb-3">{{ __('Select the safety tools you plan to use for this session.') }}</p>
