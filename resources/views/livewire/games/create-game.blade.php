        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <section class="bg-surface-container-lowest rounded-xl shadow-ambient p-5 sm:p-6">
                <div class="flex items-center gap-2.5 mb-5">
                    ...
                    <h2 class="text-lg font-heading font-semibold tracking-tight text-on-surface">{{ __('games.content_game_details') }}</h2>
                </div>
            ...
            <section class="bg-surface-container-lowest rounded-xl shadow-ambient p-5 sm:p-6">
                <div class="flex items-center gap-2.5 mb-5">
                    ...
                    <h2 class="text-lg font-heading font-semibold tracking-tight text-on-surface">{{ __('location.field_players_capacity') }}</h2>
                </div>
            ...
            <section class="bg-surface-container-lowest rounded-xl shadow-ambient p-5 sm:p-6">
                <div class="flex items-center gap-2.5 mb-5">
                    ...
                    <h2 class="text-lg font-heading font-semibold tracking-tight text-on-surface">{{ __('location.content_location') }}</h2>
                </div>
