    ...
    <div class="max-w-2xl mx-auto space-y-8">
        ...
        <div>
            <div class="flex items-center gap-3 mb-1">
                ...
                <h1 class="text-2xl font-heading font-bold tracking-tight text-on-surface">Create Game Session</h1>
            </div>
            <p class="ml-8 text-sm text-on-surface-variant">Schedule a new game session for players to join.</p>
        </div>

        {{-- Game Details --}}
        <section class="bg-surface-container-low rounded-xl shadow-ambient p-6">
            <h2 class="text-lg font-medium text-on-surface mb-4 font-heading">Game Details</h2>

            <div class="space-y-4">
                <div>
                    <label for="game-name" class="block text-sm font-medium text-on-surface mb-1">Session Name *</label>
                ...
                <div>
                    <label for="game-system" class="block text-sm font-medium text-on-surface mb-1">Game System</label>
                ...
                <div>
                    <label for="game-date-time" class="block text-sm font-medium text-on-surface mb-1">Date & Time *</label>
                ...
                <div>
                    <label for="game-description" class="block text-sm font-medium text-on-surface mb-1">Description</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label for="game-duration" class="block text-sm font-medium text-on-surface mb-1">Duration (hours)</label>
                    ...
                    <div>
                        <label for="game-price" class="block text-sm font-medium text-on-surface mb-1">Price ($)</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label for="game-language" class="block text-sm font-medium text-on-surface mb-1">Language</label>
                    ...
                    <div>
                        <label for="game-visibility" class="block text-sm font-medium text-on-surface mb-1">Visibility *</label>
        ...
        {{-- Location --}}
        <section class="bg-surface-container-low rounded-xl shadow-ambient p-6">
            <h2 class="text-lg font-medium text-on-surface mb-4 font-heading">Location</h2>

            <div>
                <label for="game-location-details" class="block text-sm font-medium text-on-surface mb-1">Location</label>
