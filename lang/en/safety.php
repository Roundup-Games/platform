...
return [
    ...
    'tool_open_door' => 'Open Door Policy',
    'tool_x_card' => 'X-Card',
    'tool_xno_card' => 'X·No Card',
    'tool_script_change' => 'Script Change',
    'tool_breaks' => 'Breaks',
    ...
    'tool_open_door_short' => 'Anyone can leave the game at any time, no questions asked.',
    'tool_x_card_short' => 'Tap the X-card to immediately pause or skip content without explanation.',
    'tool_xno_card_short' => 'A two-card system: X to pause content, N to request more of something.',
    'tool_script_change_short' => 'Use movie-style ratings (FF, RW, BR) to adjust scene intensity.',
    ...
    'tool_open_door_full' => 'A foundational safety practice that establishes an explicit policy: any player can leave the table at any time, for any reason, without judgment or questions. This removes social pressure to stay in uncomfortable situations and reinforces that the game is always voluntary.',
    'tool_x_card_full' => 'Created by John Stavropoulos, the X-Card is a simple tool: a card with an "X" placed on the table. Any player can tap or hold up the card at any time to indicate that they want the current scene or topic to change immediately — no explanation required. The group moves on without questioning the request.',
    'tool_xno_card_full' => 'An extension of the X-Card concept that adds a second card: the N (No) card. The X card signals "pause or change this" and the N card signals "I want more of this." This dual system gives players a way to express both boundaries and enthusiasm, creating richer communication during play.',
    'tool_script_change_full' => 'Created by Beau Jágr Sheldon, Script Change uses familiar movie ratings as a communication tool during play. Players can request "FF" (fast-forward — skip past this), "RW" (rewind — redo this differently), or "BR" (brake — slow down, build up to this gradually). It provides multiple levels of content adjustment beyond a simple stop.',
