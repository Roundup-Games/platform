...
return [
    ...
    'action_view_entity_type' => 'View :entity_type',
    'body_reason' => 'Reason: :reason',
    ...
    'body_weekly_digest_unsubscribe' => 'You are receiving this weekly summary because you have the weekly digest enabled.',
    'action_unsubscribe_digest' => 'Unsubscribe from the weekly digest',
    'unsubscribe_digest_success' => 'You have been unsubscribed from the weekly digest.',
    // Short, human-readable labels for each notification type in the digest.
    // Flattened (not nested) per the project's flat-lang-file convention enforced
    // by i18n:check. Keyed by the toDatabase()['type'] discriminator, prefixed
    // label_digest_ so the keys group and read consistently. The digest falls
    // back to the class basename when a key is absent, so adding a new
    // notification type never breaks the digest — it renders the fallback until
    // a key is added here.
    'label_digest_account_suspended' => 'Account Suspended',
    'label_digest_application_approved' => 'Application Approved',
    ...
    'label_digest_new_application' => 'New Application',
    'label_digest_new_follower' => 'New Follower',
    'label_digest_participant_joined' => 'Participant joined',
    'label_digest_participant_removed' => 'Participant removed',
    'label_digest_player_benched' => 'Player benched',
    'label_digest_promoted_from_bench' => 'Promoted from bench',
    'label_digest_recap_posted' => 'Recap posted',
    'label_digest_review_reported' => 'Review reported',
    'label_digest_seat_demoted' => 'Seat demoted',
    'label_digest_session_added_to_campaign' => 'Session added to campaign',
    'label_digest_session_reminder' => 'Session reminder',
    'label_digest_game_invitation' => 'Game invitation',
    'label_digest_campaign_invitation' => 'Campaign invitation',
    'label_digest_team_invitation' => 'Team invitation',
    'label_digest_team_member_removed' => 'Team member removed',
    'label_digest_waitlist_expired_rejected' => 'Waitlist expired',
    'label_digest_waitlist_placed' => 'Waitlist placed',
    'label_digest_waitlist_promoted' => 'Waitlist promoted',
    'channel_push' => 'Push',
    ...
    'action_open_dispute_report' => 'Dispute Report',
