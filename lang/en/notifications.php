...
return [
    ...
    // Keyed by the toDatabase()['type'] discriminator. The digest falls back
    // to the class basename when a key is absent, so adding a new notification
    // type never breaks the digest — it just renders the fallback until a key
    // is added here.
    'digest_labels' => [
        ...
        'attendance_resolved' => 'Attendance resolved',
        'below_min_players' => 'Below minimum players',
        'bulletin_posted' => 'Bulletin posted',
        'confirmation_expired' => 'Confirmation expired',
        'content_report_warning' => 'Content report warning',
        'debriefing_available' => 'Debriefing available',
        'dispute_resolved' => 'Dispute resolved',
        'game_system_request_approved' => 'Game system request approved',
        'game_system_request_duplicate' => 'Game system request — duplicate',
        'game_system_request_rejected' => 'Game system request rejected',
        'new_application' => 'New application',
        'new_follower' => 'New follower',
        'participant_joined' => 'Participant joined',
        'participant_removed' => 'Participant removed',
        'player_benched' => 'Player benched',
        'promoted_from_bench' => 'Promoted from bench',
        'recap_posted' => 'Recap posted',
        'review_reported' => 'Review reported',
        'seat_demoted' => 'Seat demoted',
        'session_added_to_campaign' => 'Session added to campaign',
        'session_reminder' => 'Session reminder',
        'game_invitation' => 'Game invitation',
        'campaign_invitation' => 'Campaign invitation',
        'team_invitation' => 'Team invitation',
        'team_member_removed' => 'Team member removed',
        'waitlist_expired_rejected' => 'Waitlist expired',
        'waitlist_placed' => 'Waitlist placed',
