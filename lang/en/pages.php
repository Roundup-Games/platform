...
return [
    ...
    'content_pledge_algo_people_pipeline_1_desc' => 'Starts at 4-character geohash (~20km). If fewer than 30 candidates found, expands to 3-char (~100km), then 2-char (~500km). Blocked users and existing follows are excluded.',
    ...
    'content_pledge_algo_people_pipeline_3' => 'Phase 3: Bulk Preference Loading',
    'content_pledge_algo_people_pipeline_3_desc' => 'Loads game system favorites, vibe preferences, team memberships, and follow relationships for all candidates in a single batch.',
    ...
    'content_pledge_algo_people_pipeline_5' => 'Phase 5: Paginated Results',
    'content_pledge_algo_people_pipeline_5_desc' => 'Results cached per geohash tile for 5 minutes. Paginated at 12 per page.',
