...
return [
    ...
    // About page
    'about_heading_vision' => 'Bringing People Together, One Table at a Time',
    'about_intro' => 'Roundup Games is a non-profit organization dedicated to creating in-person connections through board and tabletop gaming. We believe that rolling dice, sharing stories, and sitting face-to-face across a table builds bonds that screens never can.',
    'about_what_drives_us' => 'What Drives Us',
    'about_transparency_title' => 'Transparency',
    'about_transparency_body' => 'Every session is visible. Organizer profiles are public. We don\'t hide behind algorithms — you always know who you\'re playing with and how decisions are made.',
    'about_safety_title' => 'Safety',
    'about_safety_body' => 'Built-in safety tools, Session Zero support, and clear community guidelines. Everyone deserves to feel safe at the table, and we provide the framework to make that happen.',
    'about_inclusivity_title' => 'Inclusivity & Diversity',
    'about_inclusivity_body' => 'Every table has room for one more. Whether you\'ve played a hundred campaigns or don\'t know what a d20 is, you belong here. We actively build for newcomers, shy players, and underrepresented voices in gaming.',
    'about_community_title' => 'Investing in Community',
    'about_community_body' => 'Roundup Games is free to get started. Core features — finding sessions, joining games, creating events — cost nothing. Subscription plans for advanced organizer tools help us reinvest in the platform, fund community events, support game organizer education, and promote tabletop gaming.',
    'about_experiment_title' => 'Try Something New',
    'about_experiment_body' => 'We make it easy to experiment with new game systems and discover talented storytellers. Step outside your comfort zone — your next favorite game might be one session away.',
    'about_open_source_title' => 'Open Source',
    'about_open_source_body' => 'Roundup Games is open source. We believe in building in public, and we welcome contributions from anyone who shares our vision.',
