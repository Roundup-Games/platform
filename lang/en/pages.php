...
return [
    ...
    'content_pledge_algo_people_pipeline_1_desc' => 'Starts at 4-character geohash (~20km). If fewer than 30 candidates found, expands to 3-char (~100km), then 2-char (~500km). Blocked users and existing follows are excluded via SQL subquery. Candidate pool is capped at 100 to limit memory usage.',
    ...
    'content_pledge_algo_people_pipeline_5_desc' => 'Results are precomputed by a background job and cached per geohash tile for 5 minutes. The page reads from cache only — if the cache is cold, a "still looking" state is shown while the job runs. Paginated at 12 per page.',
