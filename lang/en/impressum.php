...
return [
    ...
    'heading_responsible' => 'Responsible for Content',
    'content_responsible_1' => 'Pursuant to § 7 Abs. 1 TMG, as a service provider, we are responsible for our own content on these pages under general law. Pursuant to §§ 8–10 TMG, we are not obligated to monitor transmitted or stored third-party information.',
    // ── Copyright ──────────────────────────────────────
    'heading_copyright' => 'Copyright',
    'content_copyright_1' => 'The content and works on these pages created by the operator are subject to German copyright law. Duplication, processing, distribution, and any form of commercialization of such material beyond the scope of the copyright law require prior written consent.',
];
