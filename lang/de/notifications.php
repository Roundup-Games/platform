...
return [
    ...
    'digest_labels' => [
        ...
        'application_approved' => 'Bewerbung angenommen',
        'application_rejected' => 'Bewerbung abgelehnt',
        'attendance_nudge' => 'Teilnahme-Erinnerung',
        'attendance_reported' => 'Teilnahme gemeldet',
        'attendance_resolved' => 'Teilnahme ermittelt',
        'below_min_players' => 'Unter Mindestspielerzahl',
        'bulletin_posted' => 'Aushang veröffentlicht',
        'confirmation_expired' => 'Bestätigung abgelaufen',
        'content_report_warning' => 'Inhaltsmeldung – Warnung',
        'debriefing_available' => 'Nachbesprechung verfügbar',
        'dispute_resolved' => 'Einspruch geklärt',
        'game_system_request_approved' => 'Spielsystem-Anfrage angenommen',
        'game_system_request_duplicate' => 'Spielsystem-Anfrage – Duplikat',
        'game_system_request_rejected' => 'Spielsystem-Anfrage abgelehnt',
        'new_application' => 'Neue Bewerbung',
        'new_follower' => 'Neuer Follower',
        'participant_joined' => 'Teilnehmer:in beigetreten',
        'participant_removed' => 'Teilnehmer:in entfernt',
        'player_benched' => 'Spieler:in auf die Bank',
        'promoted_from_bench' => 'Von der Bank befördert',
        'recap_posted' => 'Zusammenfassung veröffentlicht',
        'review_reported' => 'Rezension gemeldet',
        'seat_demoted' => 'Sitz zurückgestuft',
        'session_added_to_campaign' => 'Session zur Kampagne hinzugefügt',
        'session_reminder' => 'Session-Erinnerung',
        'game_invitation' => 'Spiel-Einladung',
        'campaign_invitation' => 'Kampagnen-Einladung',
        'team_invitation' => 'Team-Einladung',
        'team_member_removed' => 'Team-Mitglied entfernt',
        'waitlist_expired_rejected' => 'Warteliste abgelaufen',
        'waitlist_placed' => 'Auf Warteliste gesetzt',
        'waitlist_promoted' => 'Von Warteliste befördert',
    ],
    'channel_push' => 'Push',
