...
return [
    ...
    'content_safety' => 'Sicherheit',
    'content_safety_tools' => 'Sicherheitstools',
    'content_session_zero_support' => 'Session-Zero-Unterstützung',
    ...
    'tool_x_card' => 'X-Karte',
    'tool_xno_card' => 'X·Nein-Karte',
    'tool_script_change' => 'Drehbuchwechsel',
    'tool_breaks' => 'Pausen',
    ...
    'tool_open_door_short' => 'Jeder kann das Spiel jederzeit verlassen, ohne dass Fragen gestellt werden.',
    'tool_x_card_short' => 'Tippe auf die X-Karte, um Inhalte sofort zu pausieren oder zu überspringen — ohne Erklärung.',
    'tool_xno_card_short' => 'Ein Zwei-Karten-System: X zum Pausieren, N um mehr von etwas zu bitten.',
    'tool_script_change_short' => 'Nutze Filmratings (FF, RW, BR) um die Szenenintensität anzupassen.',
    ...
    'tool_open_door_full' => 'Eine grundlegende Sicherheitspraxis, die eine ausdrückliche Richtlinie etabliert: Jede:r Spieler:in kann den Tisch jederzeit verlassen, aus jedem Grund, ohne Bewertung oder Fragen. Das nimmt den sozialen Druck, in unangenehmen Situationen zu bleiben, und bekräftigt, dass das Spiel immer freiwillig ist.',
    'tool_x_card_full' => 'Erfunden von John Stavropoulos, die X-Karte ist ein einfaches Werkzeug: eine Karte mit einem „X" auf dem Tisch. Jede:r Spieler:in kann die Karte jederzeit antippen oder hochhalten, um anzuzeigen, dass die aktuelle Szene oder das Thema sofort geändert werden soll — keine Erklärung nötig. Die Gruppe wechselt ohne Rückfragen.',
    'tool_xno_card_full' => 'Eine Erweiterung des X-Karten-Konzepts mit einer zweiten Karte: der N (Nein)-Karte. Die X-Karte signalisiert „Pausieren oder Ändern" und die N-Karte signalisiert „Ich möchte mehr davon." Dieses Duale System gibt Spieler:innen die Möglichkeit, sowohl Grenzen als auch Begeisterung auszudrücken und schafft eine reichere Kommunikation während des Spiels.',
    'tool_script_change_full' => 'Erfunden von Beau Jágr Sheldon, nutzt Drehbuchwechsel vertraute Filmratings als Kommunikationsmittel während des Spiels. Spieler:innen können „FF" (Vorspulen — überspringen), „RW" (Zurückspulen — anders machen) oder „BR" (Bremsen — langsamer herantasten) anfordern. Es bietet mehrere Ebenen der Inhaltsanpassung über ein einfaches Stopp hinaus.',
