...
return [
    ...
    'content_pledge_algo_people_pipeline_1_desc' => 'Beginnt bei 4-stelligem Geohash (~20 km). Wenn weniger als 30 Kandidaten gefunden werden, wird auf 3-stellig (~100 km), dann 2-stellig (~500 km) erweitert. Blockierte Nutzer und bestehende Folgen werden per SQL-Unterabfrage ausgeschlossen. Der Kandidaten-Pool ist auf 100 begrenzt, um den Speicherverbrauch zu kontrollieren.',
    ...
    'content_pledge_algo_people_pipeline_5_desc' => 'Ergebnisse werden von einem Hintergrund-Job vorberechnet und pro Geohash-Kachel 5 Minuten lang zwischengespeichert. Die Seite liest nur aus dem Cache — wenn der Cache leer ist, wird ein "Wir suchen noch"-Status angezeigt, während der Job läuft. Paginiert mit 12 pro Seite.',
